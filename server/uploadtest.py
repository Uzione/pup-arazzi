...
# 다른 기기/다른 IP 테스트 시:
# SERVER_URL = "http://10.225.245.231:8000"

IMAGE_PATH = r"C:\Users\wooji\Downloads\152.반려동물 피부질환 데이터\01.데이터\1.Training\2_라벨링데이터_240422_add\TL01\반려견\피부\일반카메라\유증상\A1_구진_플라크\IMG_D_A1_026312.jpg"
# 테스트할 이미지 경로로 수정
